...
$sql = "SELECT * FROM student WHERE uname='$username'";
...
<nav>
    <ul>
      ...
      <li><a href="class-schedule.php">
          <span id="classschedules">CLASS SCHEDULE</span>
      </a></li>
      <li><a href="my-books.php">
      ...
      <li><a href="results.php">
          <span id="markgrades">MY RESULTS</span>
      </a></li>
      <li><a href="assignments.php">
          <span id="assignments">MY ASSIGNMENTS</span>
      </a></li>
      <li><a href="materials.php">
          <span id="materials">MATERIALS</span>
      </a></li>
      <br>
      <li><a href="mailto:yuziferr@gmail.com">
          <span id="email">SEND EMAIL</span>
      </a></li>
    </ul>
    <form method="GET">
...
<script defer>
    ...
    switch(current)
    {
        ...
        break;
        case 'batches.php': nav.childNodes[1].childNodes[3].childNodes[0].setAttribute('class','selected');
        break;
        case 'modules.php': nav.childNodes[1].childNodes[5].childNodes[0].setAttribute('class','selected');
        break;
        case 'class-schedule.php': nav.childNodes[1].childNodes[7].childNodes[0].setAttribute('class','selected');
        break;
        case 'my-books.php': nav.childNodes[1].childNodes[9].childNodes[0].setAttribute('class','selected');
        break;
        case 'library.php': nav.childNodes[1].childNodes[11].childNodes[0].setAttribute('class','selected');
        break;
        case 'results.php': nav.childNodes[1].childNodes[13].childNodes[0].setAttribute('class','selected');
        break;        
        case 'assignments.php': nav.childNodes[1].childNodes[15].childNodes[0].setAttribute('class','selected');
        break;       
        case 'materials.php': nav.childNodes[1].childNodes[17].childNodes[0].setAttribute('class','selected');
        break;       
    }
    ...
    document.querySelector('[name=saveme]').onclick = () => {
      ...
      console.log(ob);
      sqlQuery('including/me-update.php', ob, ()=>{
        if(response.success)
        {
