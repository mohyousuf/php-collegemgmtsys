...
?>
  ...
  <script>
    sqlQuery('../operator/including/batch-list.php', {search: ''}, ()=>{
    ...
    var loadModules = batch => {
      sqlQuery('../operator/including/module-list-by-batch.php', {batch : batch}, ()=>{
        if(response){
    ...
    var loadStudents = batch => {
      sqlQuery('../operator/including/student-list.php', {search : ''}, ()=>{
    ...
    document.querySelector('[name=submit]').onclick = () => {
      ...
      sqlQuery('../operator/including/grade-add.php', ob, ()=>{
        if(response.success)
        {
          showSuccess(response.success);
          loadList('../operator/including/grade-list.php',document.querySelector('table').lastSearch,['batch_id','module','student','grade'],['BATCH','MODULE','STUDENT','GRADE']);
          clearFields();
        }
    ...
    document.querySelector('[name=save]').onclick = () => {
      ...
      sqlQuery('../operator/including/grade-update.php', ob, ()=>{
        if(response.success)
        {
          showSuccess(response.success);
          loadList('../operator/including/grade-list.php',document.querySelector('table').lastSearch,['batch_id','module','student','grade'],['BATCH','MODULE','STUDENT','GRADE']);
    ...
    document.querySelector('[name=delete]').onclick = () => {
      ...
      sqlQuery('../operator/including/grade-delete.php', ob, ()=>{
        if(response.success)
        {
          showSuccess(response.success);
          loadList('../operator/including/grade-list.php',document.querySelector('table').lastSearch,['batch_id','module','student','grade'],['BATCH','MODULE','STUDENT','GRADE']);
    ...
    loadList('../operator/including/grade-list.php','',['batch_id','module','student','grade'],['BATCH','MODULE','STUDENT','GRADE']);
    ...
    {
      if(e.keyCode == 13){
        loadList('../operator/including/grade-list.php',this.value,['batch_id','module','student','grade'],['BATCH','MODULE','STUDENT','GRADE']);
      }
    }
