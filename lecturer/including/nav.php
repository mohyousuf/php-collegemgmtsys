...
$iuname = $_SESSION['lecturer_username'];
$sql = "SELECT * FROM lecturer WHERE uname='$iuname'";
...
<nav>
    <ul>
      ...
      <li><a href="class-schedule.php">
          <span id="classschedules">MY CLASS SCHEDULE</span>
      </a></li>
...
<script>
    ...
    switch(current)
    {
        ...
        break;
        case 'class-schedule.php': nav.childNodes[1].childNodes[3].childNodes[0].setAttribute('class','selected');
        break; 
        case 'results.php': nav.childNodes[1].childNodes[5].childNodes[0].setAttribute('class','selected');
        break; 
        case 'assignments.php': nav.childNodes[1].childNodes[7].childNodes[0].setAttribute('class','selected');
        break; 
        case 'materials.php': nav.childNodes[1].childNodes[9].childNodes[0].setAttribute('class','selected');
        break; 
        case 'students.php': nav.childNodes[1].childNodes[13].childNodes[0].setAttribute('class','selected');
        break; 
        case 'courses.php': nav.childNodes[1].childNodes[15].childNodes[0].setAttribute('class','selected');
        break; 
        case 'modules.php': nav.childNodes[1].childNodes[17].childNodes[0].setAttribute('class','selected');
        break; 
        case 'batches.php': nav.childNodes[1].childNodes[19].childNodes[0].setAttribute('class','selected');
        break; 
    }
