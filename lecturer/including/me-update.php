...
if(
    ...
    if($uname != $newuname){
        $sql = "SELECT * FROM lecturer WHERE uname='$newuname';";
    ...
    $sql = "UPDATE lecturer SET fname='$fname',lname='$lname',dob='$dob',address='$address',email='$email',phone='$phone',uname='$newuname',pass='$pass' WHERE uname='$uname'";
