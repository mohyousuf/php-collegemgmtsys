...
?>
    ...
    <div id="new-content">
      <form>
        <div class="new-content-field">
          ...
          <input id="title" name="title" label='MATERIAL TITLE' type="text" class="textbox2" placeholder="Assignment Brief II" >
  ...
  document.querySelector('[name=submit]').onclick = function(){
    ...
    if(dropbox.files){
      ...
      request.open('POST','including/material-add.php',true);
  ...
  function load(search){
    sqlQuery('including/material-list.php',{search:search},()=>{
  ...
  document.querySelector('[name=save]').onclick = () => {
      ...
      sqlQuery('including/material-update.php', ob, ()=>{
        if(response.success)
        {
    ...
    document.querySelector('[name=delete]').onclick = () => {
      ...
      sqlQuery('including/material-delete.php', ob, ()=>{
        if(response.success)
        {
          showSuccess(response.success);
          hideSliders();
